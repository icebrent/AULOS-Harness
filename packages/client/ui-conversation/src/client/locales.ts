...
export const zh = {
  ...
  'hero.headline': 'Orchestrate Intelligence',
  'hero.subtitle': 'The Power of AI, Harnessed.',
  'hero.chooseWorkspace': '选择工作区',
  'session.hierarchy': '会话层级',
  'session.backToChat': '返回对话',
  'session.toggleInspector': '显示或隐藏右侧栏',
  'session.inTrajectory': '完整轨迹',
  'details.title': '详情',
  'details.close': '关闭详情',
  ...
  'inspector.contextTitle': '对话上下文',
  'inspector.contextUsed': '上下文使用',
  'inspector.usedOf': '{used} / {window}',
  ...
  'inspector.read': '读取',
  'inspector.write': '写入',
  'inspector.performance': '性能',
  'inspector.ttft': 'TTFT',
  'inspector.throughput': '吞吐',
  'inspector.run': '运行',
  'inspector.turns': '轮数',
  'inspector.steps': '步数',
  'inspector.llmTime': 'LLM 时长',
  'inspector.toolTime': '工具时长',
  'inspector.empty': '暂无数据',
  'inspector.recentActivity': '近期活动',
  'inspector.recentEmpty': '还没有工具活动',
  'inspector.openTrajectory': '打开完整轨迹',
  'inspector.trajectoryHint': '查看每一步实际发生了什么（Input / Model / Tools 时间线）',
  ...
  'activity.runningSteps': '{count} 个工具运行中',
  'todo.title': '任务',
...
export const en = {
  ...
  'session.backToChat': 'Back to conversation',
  'session.toggleInspector': 'Show or hide the inspector',
  'session.inTrajectory': 'Full trajectory',
  ...
  'inspector.contextTitle': 'Conversation context',
  'inspector.contextUsed': 'Context used',
  'inspector.usedOf': '{used} / {window}',
  'inspector.tokens': 'Tokens',
  ...
  'inspector.read': 'Read',
  'inspector.write': 'Write',
  'inspector.performance': 'Performance',
  'inspector.ttft': 'TTFT',
  'inspector.throughput': 'Throughput',
  'inspector.run': 'Run',
  'inspector.turns': 'Turns',
  'inspector.steps': 'Steps',
  'inspector.llmTime': 'LLM time',
  'inspector.toolTime': 'Tool time',
  'inspector.empty': 'No data yet',
  'inspector.recentActivity': 'Recent activity',
  'inspector.recentEmpty': 'No tool activity yet',
  'inspector.openTrajectory': 'Open full trajectory',
  'inspector.trajectoryHint': 'See exactly what happened at every step (Input / Model / Tools timeline)',
  'activity.working': 'Working…',
  ...
  'activity.runningSteps': '{count} tools running',
  'todo.title': 'To-dos',
