...
describe('Hero chrome', () => {
  it('renders the brand headline and slogan through the hero locale seat', () => {
    const view = render(<HeroShell t={makeTranslate(en, commonEn)} />)
    expect(view.getByText('Orchestrate Intelligence')).toBeTruthy()
    expect(view.getByText('The Power of AI, Harnessed.')).toBeTruthy()
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText('Orchestrate Intelligence')).toBeTruthy()
    expect(b.view.getByText('The Power of AI, Harnessed.')).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText('Orchestrate Intelligence')).toBeNull()
  })
