...
This guide assumes you started the Web UI through the [upstream README](https://github.com/deepseek-ai/deepseek-harness#run). Model changes take effect on the next request without restarting the server.
