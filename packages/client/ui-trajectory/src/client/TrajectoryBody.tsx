/** Trajectory body: compact summary over a turn-aware event ledger. Shared
 *  verbatim by the full-page trajectory view tab and the bottom panel — one
 *  renderer, one data path (`snapshot.views.get('trajectory')`), so neither
 *  surface re-derives or duplicates the other's ledger. */
...
/**
 * The shared trajectory surface: toolbar, timing overview, and the
 * virtualized event ledger. Height-agnostic — the host (the full view
 * wrapper or the bottom panel) owns the box this body flex-fills.
 */
