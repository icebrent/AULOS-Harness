...
// render-site fallback. Mirrors terminal-card.spec.tsx: model derivation + null
// arms, both kinds, the chat row's collapsed-by-default ToolRow card, and the
// keyed registration. WebRow now composes the shared ToolRow, so its web card is
