...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-brand-aulos': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
  ...
  'packages/client/ui-files': { kind: 'none', reason: 'Browser-side project-tree surface over the host listing seam; registers nothing model-facing.' },
