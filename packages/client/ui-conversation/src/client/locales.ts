...
export const zh = {
  ...
  'session.toggleFiles': '显示或隐藏文件栏',
  'session.inTrajectory': '完整轨迹',
  'session.openTrajectory': '完整轨迹',
  'contextCard.context': '上下文',
  'contextCard.aria': '当前会话上下文指标',
  'contextCard.tokens': 'Tokens',
  'contextCard.tokensSub': '输入 / 输出',
  'contextCard.cache': 'Cache',
  'contextCard.ttft': 'TTFT',
...
export const en = {
  ...
  'session.toggleFiles': 'Show or hide the Files panel',
  'session.inTrajectory': 'Full trajectory',
  'session.openTrajectory': 'Full trajectory',
  'contextCard.context': 'Context',
  'contextCard.aria': 'Current session context figures',
  'contextCard.tokens': 'Tokens',
  'contextCard.tokensSub': 'Input / Output',
  'contextCard.cache': 'Cache',
  'contextCard.ttft': 'TTFT',
  'activity.working': 'Working…',
